...
class ExamplePythonType(System.Object):
    ...
    def Equals(self, other):
        if isinstance(other, ExamplePythonType):
            return self.value == other.value
        return False

    # TODO: implement catching magic methods as overrides in ClassDerived
    ...
    def __mul__(self, other):
        if isinstance(other, ExamplePythonType):
            return ExamplePythonType(self.value * other.value)
        return ExamplePythonType(self.value * other)
