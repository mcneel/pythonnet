...
from Python.Runtime import PyObjectConversions # type: ignore
from Python.Runtime.Codecs import RawProxyEncoder # type: ignore
...
def test_implicit_conversion():
    a = ImplicitCastTypeA(21)
    b = ImplicitCastTypeB(21)

    assert a + b == ImplicitCastTypeA(42)
    assert b + a != ImplicitCastTypeA(0)
